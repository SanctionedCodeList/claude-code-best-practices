...
**Recursive structure:** This pattern applies recursively. SKILL.md indexes top-level sections, each section indexes its subsections, and so on. For example:
...
- **Testable code examples**: See references/testable-code-examples.md for validating code snippets in documentation
